...
import { MapPin, Clock, AlertTriangle, CheckCircle, LogOut, Loader2, AlertCircle, History, Navigation } from "lucide-react";
    ...
    return (
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-slate-500 mt-1">Sistem Absensi GPS</p>
        </div>
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <Link
          href="/dashboard-staff/attendance/history"
