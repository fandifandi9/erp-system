    ...
    <div className="mx-auto max-w-lg space-y-4 p-6">
      ...
      <div className="rounded border bg-white p-4">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Respondents: {String((data.result as Record<string, unknown>)?.respondents_label || (data.progress as Record<string, unknown>)?.respondents_label || (data.result as Record<string, unknown>)?.respondent_count)}
        </p>
      </div>
