...
export function buildSerbaPayrollSlipHtml(
  ...
  const parts = [
    ...
    ".brand{display:flex;align-items:center;justify-content:space-between;border-bottom:3px solid #ffc107;padding-bottom:14px;margin-bottom:20px}",
    ".brand-left{display:flex;align-items:center;gap:14px}",
    ".logo{width:52px;height:52px;border-radius:12px;background:linear-gradient(135deg,#1a1a1a,#3a3a3a);color:#fff;font-weight:800;font-size:13px;display:flex;align-items:center;justify-content:center}",
    ".company{font-size:22pt;font-weight:800;color:#1a1a1a;letter-spacing:2px}",
    ...
    ".section h2{font-size:10pt;font-weight:800;text-transform:uppercase;letter-spacing:.8px;color:#1a1a1a;margin:0 0 8px;padding-bottom:4px;border-bottom:1px solid #e2e8f0}",
